...
const char HILTI_WEAK * __hlt_my_http_hlto_scope = "18d9ef17f9b36df6";

extern void __hlt_my_http::MyHTTP::__hook_RequestLine___on_0x25_done(::hilti::rt::ValueReference<RequestLine>& __self) { __hlt_my_http::MyHTTP::__hook_RequestLine___on_0x25_done_f644(__self); }
